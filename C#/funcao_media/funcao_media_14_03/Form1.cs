...
namespace funcao_media_14_03
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            this.Text = "Media escolar - Variável Indexada";            
            this.Width=329;
            this.Height=300;

            ROTULO1.Text = "Entre com as oito médias esoclares";
            ROTULO1.SetBounds(12,19,176,13);
            this.Controls.Add(ROTULO1);
           
            ROTULO2.Text = "Entre com a médis geral";
